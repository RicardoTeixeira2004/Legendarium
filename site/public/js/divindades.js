...
function mudanca(resposta) {
    if (contador == 1) {
        ...
        Pergunta.innerHTML = 'Você tem a chande de conseguir um poder único do próprio Criador, qual deles você escolhe?'
        ...
        card1.innerHTML = 'Domínio Das Plantas';
        card2.innerHTML = 'Sabedoria Infinita';
        card3.innerHTML = 'Poder de Cura';
        card4.innerHTML = 'Domínio Da Água';
        contador++
    }
        ...
        Pergunta.innerHTML = 'Como ou pelo o que você gostaria de ser lembrado ao deixar o Mundo?'
